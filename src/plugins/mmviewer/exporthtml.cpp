...
static void WriteHTMLHeader(TDirectArray<char>& output, const char* title)
{
    AppendText(output,
               ...
               "<meta name=\"author\" content=\"Generated by Sally's MultiMedia Viewer (https://github.com/0xeb/sally). Author: Tomas Jelinek (http://www.tjelinek.com)\" />\n"
               "<title>");
...
{
    AppendText(output,
               "<div style=\"text-align: center; font-size: 90%;\">Generated by <b>Sally's MultiMedia Viewer</b> (<a href=\"https://github.com/0xeb/sally\">https://github.com/0xeb/sally</a>)</div>\n");
}

...
if /I "%~3"=="Release" (
  ...
  if errorlevel 1 exit /b 1
  call :mycopy_with_mkdir_bat "%~2" "%~1" "%~1\..\..\..\..\Release_arm64\plugins\zip\zip2sfx" "Release_arm64\plugins\zip\zip2sfx"
  if errorlevel 1 exit /b 1
  exit /b 0
)

if /I "%~3"=="Release clean" (
  call :mycopy_with_mkdir_bat "%~2" "%~1" "%~1\..\..\..\..\Release clean_x64\plugins\zip\zip2sfx" "Release clean_x64\plugins\zip\zip2sfx"
  if errorlevel 1 exit /b 1
  call :mycopy_with_mkdir_bat "%~2" "%~1" "%~1\..\..\..\..\Release clean_arm64\plugins\zip\zip2sfx" "Release clean_arm64\plugins\zip\zip2sfx"
  if errorlevel 1 exit /b 1
  exit /b 0
)

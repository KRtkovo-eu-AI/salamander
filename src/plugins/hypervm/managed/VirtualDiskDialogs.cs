...
internal sealed class CreateVhdDialog : Form
{
    ...
    public CreateVhdDialog()
    {
        ...
        _path.Location = new Point(12,93); browse.Location = new Point(295,91); _size.Location = new Point(243,131); _unit.Location = new Point(323,130); _ok.SetBounds(215,438,72,24); cancel.SetBounds(295,438,72,24); AcceptButton = _ok; CancelButton = cancel; ThemeHelper.ApplyTheme(this);
    }

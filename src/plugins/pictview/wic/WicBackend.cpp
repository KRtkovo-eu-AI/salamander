...
PVCODE HResultToPvCode(HRESULT hr)
{
    ...
    case E_INVALIDARG:
#if defined(WINCODEC_ERR_INVALIDPARAMETER) && WINCODEC_ERR_INVALIDPARAMETER != E_INVALIDARG
    case WINCODEC_ERR_INVALIDPARAMETER:
#endif
#if defined(WINCODEC_ERR_VALUEOUTOFRANGE) && WINCODEC_ERR_VALUEOUTOFRANGE != E_INVALIDARG

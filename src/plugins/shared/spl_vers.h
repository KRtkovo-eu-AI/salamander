...
#else
#define VERSINFO_SAMANDARIN_VERSION VERSINFO_xstr(VERSINFO_SAMANDARIN_MAJOR) "." VERSINFO_xstr(VERSINFO_SAMANDARIN_MINORA) "." VERSINFO_xstr(VERSINFO_SAMANDARIN_MINORB)
#endif
...
#if (VERSINFO_MINORB == 0) // nulu na patch pozici nepiseme: 1.7.0 -> 1.7
...
#else
// Keep a non-zero patch component separated so 1.3.1 cannot be mistaken for
// 1.31 in the Plugins and Extensions Manager.

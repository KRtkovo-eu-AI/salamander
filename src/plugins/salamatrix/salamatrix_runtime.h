...
public:
          ...
          HostStorageRegistered(FALSE)
    {
        ...
        Registered &= Registry.RegisterServiceOwned(SALAMATRIX_SERVICE_EXTENSIONS, SALAMATRIX_EXTENSIONS_VERSION_1_4, &ExtensionsService, "Salamatrix Framework", this);
        ...
        if (General != NULL && registerHostServices)
        {
            ...
            if (HostEventsRegistered)
                HostExtensionsRegistered = General->RegisterServiceOwned(SALAMATRIX_SERVICE_EXTENSIONS, SALAMATRIX_EXTENSIONS_VERSION_1_4, &ExtensionsService, "Salamatrix Framework", this);
            if (HostExtensionsRegistered)

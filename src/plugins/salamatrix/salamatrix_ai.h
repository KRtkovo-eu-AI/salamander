...
public:
    ...
    static const char* GetStaticApiDescription()
    {
        return
            ...
            "\"Salamatrix.extensionManifest\":{\"schema\":2,\"schemaVersionAlias\":\"schemaVersion\",\"compatibleSchemaVersions\":[1,2],\"fields\":[\"id\",\"name\",\"version\",\"description\",\"runtime\",\"entryPoint\",\"capabilities\",\"commands\",\"viewers\",\"fileSystems\"],\"commandFields\":[\"id\",\"title\",\"handler\",\"path\",\"menu\",\"placement\",\"contextMenu\",\"toolbar\",\"toolbarMenu\",\"requires\"],\"fileSystemFields\":[\"id\",\"name\",\"listHandler\",\"openHandler\",\"icon\",\"iconDark\",\"defaultFileIcon\",\"refreshIntervalMs\",\"columns\",\"actions\"],\"commandPathSemantics\":\"A path-only command changes the active panel directly without starting a runtime worker, requires panels.write, and cannot also declare handler.\"},"

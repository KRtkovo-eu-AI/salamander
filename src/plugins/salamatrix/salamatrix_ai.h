...
public:
    ...
    static const char* GetStaticApiDescription()
    {
        return
            ...
            "\"Salamatrix.extensionManifest\":{\"schema\":2,\"schemaVersionAlias\":\"schemaVersion\",\"compatibleSchemaVersions\":[1,2],\"fields\":[\"id\",\"name\",\"version\",\"description\",\"runtime\",\"entryPoint\",\"capabilities\",\"commands\",\"viewers\",\"fileSystems\"],\"commandFields\":[\"id\",\"title\",\"handler\",\"menu\",\"placement\",\"contextMenu\",\"toolbar\",\"toolbarMenu\",\"requires\"]},"
...
public:
    ...
    virtual const char* WINAPI GetApiDescriptionSlice(const char* topic) const
    {
        ...
        if (strcmp(topic, "extensions") == 0 || strcmp(topic, "manifest") == 0)
            return "{\"version\":\"2.0\",\"topic\":\"extensions\",\"objects\":{\"Salamatrix.extensionManifest\":{\"schema\":2,\"schemaVersionAlias\":\"schemaVersion\",\"compatibleSchemaVersions\":[1,2],\"format\":\"strict UTF-8 JSON\",\"fields\":[\"id\",\"name|title\",\"version\",\"description\",\"runtime\",\"entryPoint\",\"capabilities\",\"commands\",\"viewers\",\"fileSystems\"],\"runtime\":\"runtime id string or object with id and minimumVersion\",\"entryPoint\":\"safe relative path; absolute and parent traversal are rejected\",\"capabilityValues\":[\"panels.read\",\"panels.write\",\"ui.dialogs\",\"commands\",\"file-operations\",\"file-system\",\"storage\",\"events\",\"ai\",\"clipboard\",\"runtimes\"],\"ungatedSurfaces\":[\"application language and appearance\",\"host metadata\"],\"commandFields\":[\"id\",\"title\",\"handler\",\"menu|placement\",\"contextMenu\",\"toolbar\",\"toolbarMenu\",\"requires\"],\"viewerFields\":[\"name\",\"patterns\",\"handler\"],\"fileSystemFields\":[\"id\",\"name\",\"listHandler\",\"openHandler\",\"icon\",\"iconDark\",\"refreshIntervalMs\",\"actions\"],\"requiresValues\":[\"any\",\"disk\",\"focused\",\"file\",\"selection\"],\"generatedPackage\":\"The assistant returns only complete entry-point source. Save as extension creates extension.json and main.<runtime extension>, binds handler main, and copies response capabilities. Do not embed a manifest in script.\"}}}";

...
public:
    ...
    static const char* GetStaticApiDescription()
    {
        return
            ...
            "\"Salamander.storage\":{\"methods\":[\"get\",\"set\",\"remove\",\"clear\",\"schema\"],\"valueTypes\":[\"string\",\"integer\",\"boolean\"],\"getResultFields\":[\"type\",\"value\"],\"schemaFields\":[\"key\",\"type\",\"hasDefault\",\"default\"]},"
            ...
            "\"Salamander.ui\":{\"methods\":[\"messageBox\",\"inputBox\",\"notify\",\"pickFile\",\"pickFolder\",\"progress\",\"progress.update\",\"progress.step\",\"progress.setTotals\",\"progress.setPositions\",\"progress.cancelled\",\"progress.close\",\"dialog\",\"dialog.add\",\"dialog.get\",\"dialog.set\",\"dialog.validation\",\"dialog.events\",\"dialog.item\",\"dialog.column\",\"dialog.selection\",\"dialog.clearItems\",\"setValidation\",\"onChange\",\"addColumn\",\"setSelectedIndex\"],\"controlKinds\":[\"label\",\"textbox\",\"checkbox\",\"radio\",\"combobox\",\"button\",\"listview\",\"treeview\",\"tabcontrol\",\"folderpicker\"],\"progressStyles\":[1,2],\"layout\":true,\"validation\":true,\"events\":true,\"selection\":true,\"notifications\":true},"
...
public:
    ...
    virtual const char* WINAPI GetApiDescriptionSlice(const char* topic) const
    {
        ...
        if (strcmp(topic, "commands") == 0)
            return "{\"version\":\"1.0\",\"topic\":\"commands\",\"objects\":{\"Salamander.commands\":{\"methods\":[\"execute\",\"register\",\"unregister\"],\"registerFields\":[\"commandId\",\"title\",\"handler\",\"pluginMenu\",\"contextMenu\",\"toolbar\",\"hotKey\"]}}}";
        ...
        if (strcmp(topic, "ui") == 0 || strcmp(topic, "dialogs") == 0)
            return "{\"version\":\"1.0\",\"topic\":\"ui\",\"objects\":{\"Salamander.ui\":{\"methods\":[\"messageBox\",\"inputBox\",\"notify\",\"pickFile\",\"pickFolder\",\"progress\",\"progress.update\",\"progress.step\",\"progress.setTotals\",\"progress.setPositions\",\"progress.cancelled\",\"progress.close\",\"dialog\",\"dialog.add\",\"dialog.get\",\"dialog.set\",\"dialog.validation\",\"dialog.events\",\"dialog.item\",\"dialog.column\",\"dialog.selection\",\"dialog.clearItems\"],\"controlKinds\":[\"label\",\"textbox\",\"checkbox\",\"radio\",\"combobox\",\"button\",\"listview\",\"treeview\",\"tabcontrol\",\"folderpicker\"],\"progressStyles\":[1,2],\"layout\":true,\"validation\":true,\"events\":true,\"selection\":true,\"notifications\":true}}}";
        ...
        if (strcmp(topic, "storage") == 0)
            return "{\"version\":\"1.0\",\"topic\":\"storage\",\"objects\":{\"Salamander.storage\":{\"methods\":[\"get\",\"set\",\"remove\",\"clear\",\"schema\"],\"valueTypes\":[\"string\",\"integer\",\"boolean\"],\"getResultFields\":[\"type\",\"value\"],\"schemaFields\":[\"key\",\"type\",\"hasDefault\",\"default\"]}}}";

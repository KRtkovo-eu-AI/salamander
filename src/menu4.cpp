...
MENU_TEMPLATE_ITEM MainMenuTemplate[] =
    {
        ...
        {MNTT_IT, IDS_MENU_FILES_COPYTOSELECTEDDIRS, MNTS_B | MNTS_I | MNTS_A, CM_COPYTOSELECTEDDIRS, -1, 0, &EnablerFilesCopy},
        ...
        {MNTT_IT, IDS_MENU_FILES_EDITPROPERTIES, MNTS_I | MNTS_A, CM_EDITPROPERTIES, -1, 0, &EnablerFilesOnDisk},
        ...
        {MNTT_IT, IDS_MENU_OPT_VSB_EXT, MNTS_B | MNTS_I | MNTS_A, CM_TOGGLEEXTENSIONBAR, -1, 0, NULL},
        ...
        {MNTT_IT, IDS_MENU_OPT_VSB_TABS, MNTS_B | MNTS_I | MNTS_A, CM_TOGGLEPANELTABS, -1, 0, NULL},
        ...
        {MNTT_IT, IDS_MENU_OPT_MANAGECONFIG, MNTS_I | MNTS_A, CM_IMPORTCONFIG, -1, 0, NULL},
        {MNTT_PE},
        ...
        {MNTT_SP, -1, MNTS_B | MNTS_I | MNTS_A, 0, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_RIGHT_DETACHPANELS, MNTS_A, CM_DETACHPANELS, -1, 0, NULL},
        ...
        {MNTT_SP, -1, MNTS_B | MNTS_I | MNTS_A, 0, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_HELP_CREDITS, MNTS_B | MNTS_I | MNTS_A, CM_HELP_CREDITS, -1, 0, NULL},
...
MENU_TEMPLATE_ITEM FindMenuTemplate[] =
    {
        ...
        {MNTT_IT, IDS_FFMENU_OPT_SORTMIXED, MNTS_B | MNTS_I | MNTS_A, CM_FIND_SORTMIXED, -1, 0, NULL},

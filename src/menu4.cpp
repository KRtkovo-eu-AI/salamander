...
MENU_TEMPLATE_ITEM MainMenuTemplate[] =
    {
        ...
        {MNTT_IT, IDS_MENU_CMD_NEWTAB, MNTS_B | MNTS_I | MNTS_A, CM_NEWTAB, IDX_TB_TABSNEW, 0, &EnablerNewTab},
        {MNTT_IT, IDS_MENU_CMD_CLOSETAB, MNTS_B | MNTS_I | MNTS_A, CM_CLOSETAB, IDX_TB_TABSCLOSE, 0, &EnablerCloseTab},
        {MNTT_IT, IDS_MENU_CMD_NEXTTAB, MNTS_I | MNTS_A, CM_NEXTTAB, IDX_TB_TABSNEXT, 0, &EnablerNextTab},
        {MNTT_IT, IDS_MENU_CMD_PREVTAB, MNTS_I | MNTS_A, CM_PREVTAB, IDX_TB_TABSPREV, 0, &EnablerPrevTab},
        {MNTT_IT, IDS_MENU_CMD_DUPLICATETAB, MNTS_I | MNTS_A, CM_DUPLICATETAB, IDX_TB_TABSDUPLICATE, 0, &EnablerDuplicateTab},
        {MNTT_SP, -1, MNTS_B | MNTS_I | MNTS_A, 0, -1, 0, NULL},

#!/usr/bin/env python3
"""
translate_slt.py - AI-powered translation of Samandarin .slt archives.
...
This is for Samandarin, a dual-panel file manager for Windows (fork of Open Salamander).
...
6. Preserve the Samandarin plural syntax exactly: {{!}} markers and the {{text|N|text|N|text}} pattern. Translate the text parts inside the curly braces but keep the numeric thresholds and pipe structure. Adapt the plural forms to {language_name} grammar.
...
def main():
    parser = argparse.ArgumentParser(
        description="Translate Samandarin .slt archives using Claude API",

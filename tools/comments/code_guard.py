...
EXCLUDE_PATTERNS = [
    ...
    'src/plugins/webviewer/cmark-gfm/build/src',
    'src/plugins/webviewer/cmark-gfm/src',
...
def get_clang_args(repo_path: Path) -> list:
    ...
    isystem_paths = [
        ...
        'src/plugins/ftp/openssl',
        'src/plugins/webviewer/cmark-gfm/build/src',
        'src/plugins/webviewer/cmark-gfm/build/extensions',
        'src/plugins/webviewer/cmark-gfm/extensions',
        'src/plugins/webviewer/cmark-gfm/src',

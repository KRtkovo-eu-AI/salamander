...
| Command shell template SVG icons | Windows Terminal profile menu icons | SVG artwork adapted from Microsoft product icon shapes for PowerShell, Windows PowerShell, and Visual Studio, and from the SVG Repo Azure Cloud Shell icon. |

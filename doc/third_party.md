...
Open Salamander Samandarin builds on the work of many authors, maintainers, and
...
Samandarin includes code and implementation work derived from, or substantially
informed by, [Sally](https://github.com/0xeb/sally) by 0xeb. In particular,
portions of the Unicode viewer, filename handling, and localization tooling were
adapted from or substantially informed by Sally.

...
| win32-darkmodelib | Natívna podpora tmavého režimu Windows pre zdieľané dialógy a dialógy Salamatrix | Prevzaté z [ozone10/win32-darkmodelib](https://github.com/ozone10/win32-darkmodelib), commit `b58eb027c4a114c1b1c8fd09870ead982f1b1e72`. Licencia Mozilla Public License 2.0, časti pod licenciou MIT.; see `src/third_party/darkmodelib/LICENSE.md` and `LICENSE-MIT.md`. |
| llama.cpp | Spustiteľný súbor pre lokálnu CPU inferenciu SalamatrixAI na požiadanie | [ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp), pripnuté vydanie `b10107`. Licencia MIT. The configuration downloader retrieves the runtime and its license notice directly for the user. |
| Qwen2.5-Coder 1.5B Instruct GGUF | Odporúčaný lokálny model SalamatrixAI | [Qwen/Qwen2.5-Coder-1.5B-Instruct-GGUF](https://huggingface.co/Qwen/Qwen2.5-Coder-1.5B-Instruct-GGUF), pripnutý súbor `q4_k_m`. Licencia Apache 2.0. The configuration downloader retrieves the model and license notice directly for the user. |
| Qwen2.5-Coder 0.5B Instruct GGUF | Ľahký lokálny model SalamatrixAI iba pre anglické prompty | [Qwen/Qwen2.5-Coder-0.5B-Instruct-GGUF](https://huggingface.co/Qwen/Qwen2.5-Coder-0.5B-Instruct-GGUF), pripnutý súbor `q4_k_m`. Licencia Apache 2.0. The configuration downloader retrieves the model and license notice directly for the user. |
| Test Reporter | Správy s výsledkami testov pull requestov | [dorny/test-reporter](https://github.com/dorny/test-reporter), používané v GitHub Actions. Licencia MIT. It publishes JUnit and Python xUnit results as Checks and workflow summaries. |
...
| TagLib 2.3 | Plugin Multimedia Viewer | Knižnica zvukových metadát od Scotta Wheelera a prispievateľov projektu TagLib. Používa sa pre Unicode metadáta a zvukové vlastnosti formátov Ogg Vorbis, Opus, FLAC, MP4, APE, WavPack, TrueAudio, AIFF, DSD, Matroska/WebM a súvisiacich formátov. Distribuované pod licenciou GNU LGPL 2.1 alebo Mozilla Public License 1.1. Zdroj: https://github.com/taglib/taglib |
...
| Prism.js 1.29.0 | Viewer Frame (Salamatrix a Prism Text Viewer) | Od Ley Verou a prispievateľov PrismJS, vydané pod MIT License. |
| Microsoft.Web.WebView2 1.0.2420.47 | Viewer Frame | Od Microsoft Corporation, distribuované pod BSD 3-Clause License. |
| Markdig 0.36.2 | MarkdigRenderer pre WebView2 Render Viewer | Od Alexendra Mutela a prispievateľov, vydané pod BSD 2-Clause License. |
...
| Dupl3xx | Plugin SFTP | Plugin vytvoril a udržiava Dupl3xx. Zdrojový repozitár: [salamander-sftp-plugin](https://github.com/Dupl3xx/salamander-sftp-plugin). |
...
## Rozšírenie Monitor hardvéru

| Komponent | Použitie v | Informácie o autorstve a licencii |
| --- | --- | --- |
| HardView | Rozšírenie Monitor hardvéru | C++/CLI mostová knižnica pre monitorovanie hardvéru. Copyright (c) 2025 gafoo. Licencované pod MIT License. Zdroj: [gafoo173/HardView](https://github.com/gafoo173/HardView). |
| LibreHardwareMonitorLib 0.9.6.0 | Rozšírenie Monitor hardvéru | .NET knižnica pre monitorovanie hardvéru. LibreHardwareMonitorLib je licencovaná pod GNU General Public License v3.0. Zdroj: [LibreHardwareMonitor/LibreHardwareMonitor](https://github.com/LibreHardwareMonitor/LibreHardwareMonitor). |
| HidSharp 2.6.4.0 | Rozšírenie Monitor hardvéru | Knižnica pre prístup k HID zariadeniam, prechodná závislosť LibreHardwareMonitorLib. Copyright (C) 2010 James F. Bellinger. Licencovaná pod GNU Lesser General Public License v3.0. |

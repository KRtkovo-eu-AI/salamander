...
- `Salamatrix.AI` has a provider-neutral contract. The standalone
  ...
  ceiling; the optional `SalamatrixAI Local Llama.SPL` companion registers a
...
The current implementation separates the optional `SalamatrixAI Local

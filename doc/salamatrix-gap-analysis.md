...
- build Salamatrix and Automation Debug x64, run the API protocol test, and
  syntax-check all four runtime worker implementations. The optional
  process-runtime integration run was skipped because `SALAMATRIX_WORKER_ROOT`

...
- The strict schema-1 manifest parser validates package/runtime identity,
  ...
  unresolved packages stay visible as waiting-for-dependency; localization,
  settings migrations/files, and richer handler lifecycle metadata are still
  missing.

...
| win32-darkmodelib | Suport nativ pentru modul întunecat Windows în dialogurile comune și Salamatrix | Preluat din [ozone10/win32-darkmodelib](https://github.com/ozone10/win32-darkmodelib), commit `b58eb027c4a114c1b1c8fd09870ead982f1b1e72`. Mozilla Public License 2.0, cu părți sub licența MIT.; see `src/third_party/darkmodelib/LICENSE.md` and `LICENSE-MIT.md`. |
| llama.cpp | Executabil de inferență CPU locală pentru SalamatrixAI | [ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp), versiunea fixată `b10107`. Licență MIT. The configuration downloader retrieves the runtime and its license notice directly for the user. |
| Qwen2.5-Coder 1.5B Instruct GGUF | Model local SalamatrixAI recomandat | [Qwen/Qwen2.5-Coder-1.5B-Instruct-GGUF](https://huggingface.co/Qwen/Qwen2.5-Coder-1.5B-Instruct-GGUF), fișierul fixat `q4_k_m`. Licență Apache 2.0. The configuration downloader retrieves the model and license notice directly for the user. |
| Qwen2.5-Coder 0.5B Instruct GGUF | Model local SalamatrixAI ușor, doar pentru prompturi în engleză | [Qwen/Qwen2.5-Coder-0.5B-Instruct-GGUF](https://huggingface.co/Qwen/Qwen2.5-Coder-0.5B-Instruct-GGUF), fișierul fixat `q4_k_m`. Licență Apache 2.0. The configuration downloader retrieves the model and license notice directly for the user. |
| Test Reporter | Rapoarte cu rezultatele testelor pentru pull request-uri | [dorny/test-reporter](https://github.com/dorny/test-reporter), utilizat în GitHub Actions. Licență MIT. It publishes JUnit and Python xUnit results as Checks and workflow summaries. |
...
| TagLib 2.3 | Plugin Multimedia Viewer | Bibliotecă de metadate audio realizată de Scott Wheeler și colaboratorii TagLib. Folosită pentru metadate Unicode și proprietăți audio în formatele Ogg Vorbis, Opus, FLAC, MP4, APE, WavPack, TrueAudio, AIFF, DSD, Matroska/WebM și formate înrudite. Distribuită sub GNU LGPL 2.1 sau Mozilla Public License 1.1. Sursă: https://github.com/taglib/taglib |
